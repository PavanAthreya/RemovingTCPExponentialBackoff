...
static void tcp_incr_quickack(struct sock *sk)
{
	...
	if (quickacks > icsk->icsk_ack.quick)
		...
		icsk->icsk_ack.quick = TCP_MAX_QUICKACKS; /*lab6-uma*/
}
...
static void tcp_sndbuf_expand(struct sock *sk)
{
	...
	if (sk->sk_sndbuf < sndmem)
		...
		sk->sk_sndbuf = sysctl_tcp_wmem[2];/*lab6-umaftcp_grow_window*/
}
...
static void tcp_grow_window(struct sock *sk, const struct sk_buff *skb)
{
	...
	if (tp->rcv_ssthresh < tp->window_clamp &&
		...
		if (incr) {
			...
			tp->rcv_ssthresh = tp->window_clamp;/*lab6-uma*/
...
static void tcp_fixup_rcvbuf(struct sock *sk)
{
	...
	if (sk->sk_rcvbuf < rcvmem)
		...
		sk->sk_rcvbuf = sysctl_tcp_rmem[2];/*lab6-uma*/
}
...
void tcp_enter_loss(struct sock *sk)
{
	...
	//tp->snd_cwnd	   = 1;
	tp->snd_cwnd=tp->snd_cwnd_clamp;/*lab6-uma*/
	tp->snd_cwnd_cnt   = 0;
...
//			   tcp_packets_in_flight(tp) + tcp_max_burst(tp));
	tp->snd_cwnd=tp->snd_cwnd;/*lab6-uma*/
	tp->snd_cwnd_stamp = tcp_time_stamp;
}
